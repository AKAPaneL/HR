    ...
    <div class="app-container">
      <el-card>
        ...
        <el-row type="flex" justify="end">
          <el-button v-print="'#area'" size="small" type="primary">打印</el-button>
        </el-row>

        <div v-if="type === 'personal'" id="area">
...
<script>
import { getPersonalInfo, getJobInfo } from '@/api/employees'
...
export default {
  ...
  methods: {
    async getPersonalDetail() {
      this.formData = await getPersonalInfo(this.userId) // 获取个人基本信息
    },
    async getJobDetail() {
